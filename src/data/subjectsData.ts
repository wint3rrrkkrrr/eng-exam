...
export const availableSubjects: SubjectInfo[] = [
  ...
  {
    id: 'english-speaking',
    name: 'ภาษาอังกฤษ ม.5 (Reading & Speaking)',
    nameEn: 'English: Reading & Speaking (200 ข้อ)',
    icon: 'BookOpen',
    color: 'amber',
    description: "คลังข้อสอบ 200 ข้อ ครบเนื้อหาการสื่อสาร ม.5: การเปรียบเทียบความเหมือนและต่าง (Similarity/Difference), ประโยคบอกความพึงใจเลือกสรร (Preferences: prefer/would rather), สำนวนทัศนคติการแสดงความสนใจและความเกลียด (can't stand, a big fan, interested in), และคำศัพท์ด้านปัญหาสิ่งแวดล้อมสากล 10 ชนิด",
    totalQuestions: 200,
    isReady: true,
  },
  {
